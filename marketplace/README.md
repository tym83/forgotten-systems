...
cozypkg tap forgotten-systems-machines  # подключить репозиторий
...
Образы контейнеров, ссылка на реестр и подписи помечены `REPLACE-ME`. Ничего не
опубликовано: каталог нельзя применить, не подставив своё. Сборка загрузочных
образов машин — отдельная работа, здесь только механика их публикации.
