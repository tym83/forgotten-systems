...
static void print_cycle_stats(void) {
  if (getenv("NOREBO_CYCLES"))
    fprintf(stderr, "CYCLES %llu INSNS %llu\n",
            (unsigned long long)risc_cycles, (unsigned long long)risc_insns);
  if (getenv("NOREBO_PROFILE")) {
    static const char *nm[8] = {"0-15","16-63","64-127","128-255",
                                "256-1023","1024-4095","4096-65535",">65535"};
